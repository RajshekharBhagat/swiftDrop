...
function Button({
  ...
  return (
    ...
    >
      {isLoading ? (
        bounce ? (
          <div className="flex mr-1.5 gap-0.5 justify-center items-center dark:invert">
          ...
          <svg
              aria-hidden="true"
              role="status"
              className="inline w-4 h-4 mr-1.5 text-violet-200 animate-spin dark:text-gray-600"
              viewBox="0 0 100 101"
              fill="none"
